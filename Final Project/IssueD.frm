...
Begin VB.Form IssueD 
   Caption         =   "User Issue Details"
   ClientHeight    =   5424
   ClientLeft      =   108
   ClientTop       =   456
   ClientWidth     =   9420
...
Adodc1.RecordSource = "Select * from Issue where Mem_id='" & Form5.Text1.Text & "'"
End Sub
